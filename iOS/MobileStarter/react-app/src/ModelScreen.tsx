...
export function ModelScreen(props: ModelScreenProps) {
  ...
  const modelsLabel = React.useMemo(() => i18n("ModelScreen", "Models"), []);
  const categoriesLabel = React.useMemo(() => i18n("ModelScreen", "Categories"), []);
